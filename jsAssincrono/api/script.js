...
// EXEMPLOS DE API´S
//GitHub
//https://api.github.com/users/origamid // aqui eu interajo com a api pelo url, e a resposta é um arquivo json
...
const options = {
  method: 'POST',
  headers: {
    "Content-Type": "application/json; charset=utf-8",    // indica o tipo de dado que estou enviando ao server
  },
...
// Se tiver tendo algum erro relacionado ao CORS, É pq não é permitido essa interação do script com uma origem diferente, é possivel passar por cima disso com o proy, existe um repositorio no github que faz isso