...
const button = {
  get element() {
    return this._element;  // o _ significa que é uma propriedade privada
  },
  set element(tipo) { // ao criar um set é necessario utilizar o mesmo nome que foi usado no get
...
const blueButton123 = new Button('Comprar');
blueButton.element; // retorna o elemento